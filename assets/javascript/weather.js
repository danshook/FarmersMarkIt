$(document).ready(function(){
	...
	$.ajax({
		url: 'https://api.openweathermap.org/data/2.5/weather?id=5308655&appid=028ca2a1c72ae0a27b9432b8005fae88&units=imperial',
		type: "GET"
	...
	$.ajax({
		url: 'https://api.openweathermap.org/data/2.5/weather?id=5317058&appid=4b7dec207637026b068ebbe15f2de199&units=imperial',
		type: "GET"
		}).then(function(response){
		...
		$.ajax({
		url: 'https://api.openweathermap.org/data/2.5/weather?id=5295903&appid=1a71012b82a2720bed53b81eb544988c&units=imperial',
		type: "GET"
		}).then(function(response){
		...
		$.ajax({
		url: 'https://api.openweathermap.org/data/2.5/weather?id=5308655&appid=136372444981f95741f23131958cb253&units=imperial',
		type: "GET"
		}).then(function(response){
		...
		$.ajax({
		url: 'https://api.openweathermap.org/data/2.5/weather?q=Scottsdale,us&appid=22e8aef8d44651f51f40eb4812f529cd&units=imperial',
		type: "GET"
		}).then(function(response){
